...
function renderContentHtml(i, finalPokemonName) {
    return  `
            <div onmouseout="opacityMouseOut(${i})" onmousemove="opacityMouseOn(${i})" onclick="showData(${i})" class="content" id="content${i}">
...
function renderMoreContentHtml(i, finalPokemonName) {
    return `
            <div onmouseout="opacityMouseOut(${i})" onmousemove="opacityMouseOn(${i})" onclick="showData(${i})" class="content" id="content${i}">
                <div class="pokemonCard" id="card${i}">
                    <p>#${pokemonData[i].id}
